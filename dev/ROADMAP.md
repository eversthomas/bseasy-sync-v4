...
> **Operative Prioritäten:** Siehe [`docs/BACKLOG.md`](../docs/BACKLOG.md) — diese Datei beschreibt die technischen Maßnahmen im Detail (A–J).  
> **Getestet:** [`docs/MANUAL_TESTS.md`](../docs/MANUAL_TESTS.md) · **Migration:** [`docs/MIGRATION.md`](../docs/MIGRATION.md)
